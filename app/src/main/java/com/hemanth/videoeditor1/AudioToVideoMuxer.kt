...
class AudioToVideoMuxer {
    ...
    fun mux(audioFile: String, videoFile: String, outPutFile: String) {
        try {
            init(audioFile, videoFile, outPutFile)
        } catch (e: Exception) {
            e.printStackTrace()
        } finally {
//            cleanUp()
    ...
    fun init(audioFile: String, videoFile: String, outPutFile: String) {
