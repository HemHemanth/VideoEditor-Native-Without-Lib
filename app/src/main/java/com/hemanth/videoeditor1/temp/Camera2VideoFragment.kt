...
package com.hemanth.videoeditor1.temp
...
import com.example.android.camera2video.REQUEST_VIDEO_PERMISSIONS
import com.example.android.camera2video.VIDEO_PERMISSIONS
...
class Camera2VideoFragment : Fragment(), View.OnClickListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.video).setOnClickListener(this)
...
//                previewRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE, CaptureRequest.CONTROL_AE_MODE_ON_AUTO_FLASH)
    ...
    private fun setUpMediaRecorder() {
        ...
        mediaRecorder?.apply {
            ...
            setCaptureRate(profile.videoFrameRate / 6.0)
